...
const Services = () => {
  ...
  const servicesList = [
    {
      id: 1,
      icon: <FaCarSide className="text-4xl text-red-600 mb-4" />,
    ...
    {
      id: 2,
      icon: <FaRegClock className="text-4xl text-red-600 mb-4" />,
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Banner */}
      <div className="bg-gradient-to-r from-red-700 to-red-500 py-20 px-4">
            ...
            {servicesList.map((service) => (
              <div key={service.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, index) => (
                      <li key={index} className="flex items-start">
                        <FaLongArrowAltRight className="text-red-600 mt-1 mr-2 flex-shrink-0" />
                ...
                <div className="p-4 bg-gray-50 border-t">
                  <Link 
                    to="/contact" 
                    className="block w-full py-2 px-4 bg-red-600 text-white text-center rounded-md hover:bg-red-700 transition-colors duration-300"
                  >
                    Tìm hiểu thêm
                  </Link>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md text-center relative">
              <div className="w-12 h-12 bg-red-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">1</div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center relative">
              <div className="w-12 h-12 bg-red-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">3</div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-12 h-12 bg-red-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">4</div>
      ...
      <div className="py-16 px-4 bg-gray-900">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/cars" className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-8 rounded-md transition-colors">
              Xem danh sách xe
            </Link>
