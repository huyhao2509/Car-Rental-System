      ...
      <div className="container mx-auto min-h-[500px]">
        <div className="grid grid-cols-1 md:grid-cols-2 place-items-center gap-8">
          ...
          <div className="order-1 md:order-2 relative">
            ...
            {/* More friendly badge */}
            <div className="absolute -top-3 right-10 bg-red-800 text-white text-sm font-medium px-3 py-1 rounded-lg shadow-md">
              Dễ Thuê
            </div>
          </div>
          ...
          <div className="space-y-6 order-2 md:order-1 md:pr-10 text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 max-w-xl">
              Trải nghiệm dịch vụ thuê xe tự lái chất lượng. Nhiều lựa chọn xe,
              giá cả hợp lý, thủ tục đơn giản.
            </p>
